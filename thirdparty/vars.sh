...
# paimon-cpp
PAIMON_CPP_DOWNLOAD="https://github.com/alibaba/paimon-cpp/archive/refs/tags/v0.2.0.tar.gz"
PAIMON_CPP_NAME="paimon-cpp-v0.2.0.tar.gz"
PAIMON_CPP_SOURCE="paimon-cpp-0.2.0"
PAIMON_CPP_MD5SUM="e36b5f71df4e43e7662f3c74635c4024"
...
TP_ARCHIVES="CLUCENE LIBEVENT OPENSSL THRIFT PROTOBUF GFLAGS GLOG GTEST RAPIDJSON SIMDJSON SNAPPY GPERFTOOLS ZLIB LZ4 BZIP CURL \
            ...
            FIU LIBDEFLATE LLVM ABSL CARES GRPC SIMDUTF TENANN POCO ICU XSIMD LIBXML2 AZURE LIBDIVIDE PAIMON_CPP"
